          ...
          <div class="row mb-3">
            ...
            <div class="col-6">
              ...
              <div class="form-check mt-2">
                <input type="checkbox" class="form-check-input noEndDate" id="noEndDateHabit">
                <label class="form-check-label small text-muted" for="noEndDateHabit">{{ __('No End Date') }}</label>
              </div>
            </div>
          </div>
