        ...
        <form action="{{ route('tasks.store') }}" method="post">
            @csrf
                <div class="modal-body">
                    <h5 class="modal-title mb-4 fw-bold text-dark">{{ __('Add Task') }}</h5>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select border bg-white rounded-3 px-3 py-2" name="priority_type" required>
                            ...
                            <option value="3">{{ __('Not Important & Urgent') }}</option>
                            <option value="4">{{ __('Not Important & Not Urgent') }}</option>
                        </select>
                    </div>
                    ...
                    <div id="repeatArea" style="display:none;">
                        <div class="border rounded-3 p-3 mb-3">
                            ...
                            <div class="mb-3 d-flex align-items-center">
                                ...
                                <span class="ms-2 taskIntervalUnit text-muted small">{{ __('day(s)') }}</span>
                            </div>
