        ...
        <div class="modal-content p-3 border-0 shadow-lg rounded-4">
            <form id="deleteNotificationForm" action="" method="POST">
                ...
                <div class="modal-body text-center pt-4">
                    ...
                    <h5 class="fw-bold text-dark mb-3">{{ __('Delete Notification') }}</h5>
                    <p class="text-muted mb-4">{{ __('Are you sure you want to delete this notification?') }}<br>{{ __('This action cannot be undone.') }}</p>
