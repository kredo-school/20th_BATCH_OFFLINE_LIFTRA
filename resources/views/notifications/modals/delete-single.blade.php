        ...
        <form id="deleteNotificationForm" action="" method="POST">
            ...
            <div class="modal-content p-3 border-0 shadow-lg rounded-4">
                <div class="modal-body text-center pt-4">
                    ...
                    <h5 class="fw-bold text-dark mb-3">Delete Notification</h5>
                    <p class="text-muted mb-4">Are you sure you want to delete this notification?<br>This action cannot be undone.</p>
                </div>
