...
@push('styles')
    <style>
        ...
        .header-action-btn:hover {
            color: {{ $category->color->code ?? '#6366F1' }} !important;
        }
        ...
        <div class="container-fluid px-2 px-md-4">
            <div class="d-flex justify-content-between align-items-center px-lg-2 px-1">
                ...
                <div class="d-flex align-items-center gap-2">
                    <!-- Desktop Button -->
                    <a href="#"
                        class="btn btn-light header-action-btn rounded-3 px-4 fw-semibold shadow-sm d-none d-md-inline-block me-5"
                        style="color: {{ $category->color->code ?? '#6366F1' }};" data-bs-toggle="modal"
                        data-bs-target="#addGoalModal">
                        <i class="fa-solid fa-plus me-2"></i> {{ __('Add Goals') }}
                    </a>
                    <!-- Mobile Button -->
                    <a href="#"
                        class="btn btn-light header-action-btn shadow-sm d-md-none d-flex align-items-center justify-content-center p-0"
                        style="color: {{ $category->color->code ?? '#6366F1' }}; width: 42px; height: 42px; border-radius: 12px;"
    ...
    @if (is_null($userAge))
        <div class="container-fluid px-3 px-md-5 mt-4 mb-5">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div
                        class="alert alert-danger border-0 shadow-sm rounded-4 d-flex align-items-center justify-content-between p-3 px-4 mb-0">
                        <div class="d-flex align-items-center gap-3">
                            <i class="fa-solid fa-cake-candles fs-5 text-danger"></i>
                            <span
                                class="fw-medium text-dark">{{ __('Please enter your birthday to use the goal feature.') }}</span>
                        </div>
            ...
            <div class="col-12">
                ...
                @else
                    <div class="timeline-container" style="position: relative;">
                        {{-- Vertical line --}}
                        <div
                            style="position: absolute; left: 30px; top: 0; bottom: 0; width: 2px; background: #E5E7EB; z-index: 0;">
                        </div>
                            ...
                            <div class="mb-5" style="position: relative;">
                                ...
                                <div class="d-flex align-items-center mb-3" style="position: relative;">
                                    <div style="width: 62px; flex-shrink: 0; position: relative; z-index: 1;">
                                        <div
                                            style="width: 12px; height: 12px; background: #D1D5DB; border-radius: 50%; margin: 0 auto;">
                                        </div>
                                    </div>
                                ...
                                @foreach ($goals as $goal)
                                    @php
                                        ...
                                        $milestonesCompleted = $goal->milestones
                                            ->filter(fn($m) => !is_null($m->completed_at))
                                            ->count();
                                        $goalProgress =
                                            $milestonesTotal > 0
                                                ? round(($milestonesCompleted / $milestonesTotal) * 100)
                                                : 0;
                                    ...
                                    <div class="d-flex align-items-start mb-3" style="position: relative;">
                                        ...
                                        {{-- Goal Card --}}
                                        <div
                                            class="card shadow-sm border-0 rounded-4 p-3 flex-grow-1 text-decoration-none text-dark goal-card-hover position-relative">
                                            ...
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                ...
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="dropdown position-relative" style="z-index: 5;">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end p-0 shadow-sm border-0"
                                                            style="min-width: 120px;">
                                                            <li><a class="dropdown-item btn btn-light text-secondary py-1"
                                                                    href="#" data-bs-toggle="modal"
                                                                    data-bs-target="#editGoalModal{{ $goal->id }}"><i
                                                                        class="fa-solid fa-pen-to-square me-2"></i>{{ __('Edit') }}</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item btn btn-light text-danger py-1"
                                                                    href="#" data-bs-toggle="modal"
                                                                    data-bs-target="#deleteGoalModal{{ $goal->id }}"><i
                                                                        class="fa-solid fa-trash-can me-2"></i>{{ __('Delete') }}</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="progress mt-1" style="height: 6px; border-radius: 10px;">
                                                <div class="progress-bar" role="progressbar"
                                                    ...
                                                    aria-valuenow="{{ $goalProgress }}" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                </div>
                                            </div>
                                        </div>
