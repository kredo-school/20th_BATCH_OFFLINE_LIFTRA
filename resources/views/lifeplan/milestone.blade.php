...
@push('styles')
    <style>
        ...
        @media (max-width: 991.98px) {
            .milestone-top-header {
                padding: 12px 24px 12px 75px !important;
            }
        }
    </style>
@endpush
...
@section('content')
    ...
    <div class="milestone-top-header"
        ...
        <div class="d-flex align-items-start gap-3">
            ...
            <div class="d-none d-lg-block flex-shrink-0 my-auto">
                <a href="{{ route('lifeplan.category.show', $category) }}" class="text-white text-decoration-none ms-0">
            ...
            <div class="flex-grow-1 w-100">
                <div class="text-white small">{{ $category->name }}</div>

                <div class="d-flex justify-content-between align-items-center ">
                    <h2 class="fw-bold text-white pe-3 my-1 " style="font-size: 1.75rem;">{{ $goal->title }}</h2>

                    <div class="flex-shrink-0 d-flex align-items-center gap-2 mt-2 my-1" id="tour-add-milestone-wrapper">
                    <!-- Desktop Button -->
                        <button class="btn btn-light header-action-btn rounded-3 px-4 fw-semibold shadow-sm d-none d-md-inline-block me-5"
                ...
                @if ($goal->description)
                    <p class="text-white small" style="max-width: 800px;">{{ $goal->description }}</p>
                @endif
            </div>
        </div>
    </div>
                                    ...
                                    <div class="d-flex gap-3 mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            @if ($milestone->due_date)
                                                <div class="milestone-due mt-1"><i
                                                        class="fa-regular fa-calendar me-1"></i>{{ __('Due') }}
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-0 border-0 shadow-sm rounded-3"
                                                ...
                                                <li>
                                                    <a class="dropdown-item btn btn-light text-danger py-1" href="#"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#deleteMilestoneModal{{ $milestone->id }}"><i
                                        ...
                                        <div class="ms-4 d-flex flex-column gap-2">
                                            @foreach ($mActions as $action)
                                                <div class="d-flex align-items-center gap-2 action-item">
                                                    ...
                                                    @if ($action->due_date)
                                                        <span class="action-due"><i
                                                                class="fa-regular fa-calendar me-1"></i>{{ $action->due_date->format('M j') }}</span>
                                                    @endif
                                                </div>
                                            @endforeach
                                        </div>
